...
public class ActiveDoctor implements ValidateScheduleConsulation {
    private final DoctorRepository doctorRepository;
    public void validate(RegisterCosulationDTO registerCosulationDTO) {
        if (!doctorRepository.isDoctorActive(registerCosulationDTO.getIdMedico())){
            throw new ValidationConsulationException("Médico não está ativo.");
        }
    }
}
